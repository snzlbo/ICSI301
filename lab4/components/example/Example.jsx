...
class Example extends React.Component {
  constructor(props) {
    ...
    let states = window.cs142models.exampleModel()
    this.state = {
      name: states.name,
      motto: states.motto,
      counter: 0,
    ...
    return (
      <div className="container Example">
        ...
        <div className="motto-update">
          <label htmlFor="InId">
            Enter motto here:
          <input type="text" placeholder={this.state.motto} onChange={(event) => this.handleMotto(event)}/>
          <p>Hello {this.state.name}! </p> 
          Your motto is {this.state.motto}.
          </label>
        </div>
